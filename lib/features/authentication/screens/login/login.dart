...
import 'package:p_store/common/widgets/login_signup/form_divider.dart';
import 'package:p_store/common/widgets/login_signup/social_buttons.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              /// Divider
              TFormDivider(dividerText: TTexts.tOrSignInWith.capitalize!),
